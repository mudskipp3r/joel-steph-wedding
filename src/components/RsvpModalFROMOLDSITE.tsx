...
function RsvpModal({ onClose }) {
  ...
  const modalStyles = {
    overlay: {
      ...
      zIndex: 10000, // Higher z-index to ensure it's above ScrollSmoother
      display: "flex",
      ...
      paddingTop: "2rem", // Ensure top spacing
      paddingBottom: "2rem", // Ensure bottom spacing
    },
    modalContainer: {
      background: "white",
      borderRadius: "12px",
      width: "100%",
      maxWidth: "700px",
      minHeight: "auto", // Remove fixed height constraints
      position: "relative",
      boxShadow: "0 20px 60px rgba(0, 0, 0, 0.3)",
      margin: "auto", // Center horizontally
      marginTop: "2rem", // Top spacing
      marginBottom: "2rem", // Bottom spacing
      maxHeight: "calc(100vh - 4rem)", // Ensure it doesn't exceed viewport
      overflowY: "auto", // Enable internal scrolling if needed
